...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('post_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('post_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('post_image', $e, $a, $b));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'blog', 'user' => 'blog', 'password' => '3WY2fyy4eU71iwOU', 'charset' => 'UTF8', 'driverOptions' => array()), $d, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Blog\\MainBundle\\Entity'))), 'Blog\\MainBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('BlogMainBundle' => 'Blog\\MainBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_09fe1df78e6a3d2fad79f036a2afb369822ff4c9caec86ec9c6fb93046d1c2ec');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Blog\\MainBundle/Resources/views'), 'BlogMain');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('BlogToken!');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'\\src\\Blog\\MainBundle\\Resources\\config\\validation.yml')));
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('post_image' => array('uri_prefix' => '/bundles/blogmain/images/posts/', 'upload_destination' => ($this->targetDirs[2].'/../web/bundles/blogmain/images/posts/'), 'namer' => array('service' => NULL, 'options' => NULL), 'directory_namer' => array('service' => NULL, 'options' => NULL), 'delete_on_remove' => true, 'delete_on_update' => true, 'inject_on_load' => false, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BlogMainBundle' => 'Blog\\MainBundle\\BlogMainBundle',
            ...
            'database_name' => 'blog',
            'database_user' => 'blog',
            'database_password' => '3WY2fyy4eU71iwOU',
            ...
            'vich_uploader.mappings' => array(
                'post_image' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[2].'/../web/bundles/blogmain/images/posts/'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
